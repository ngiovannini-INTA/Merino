...
#Procesar lotes por sexo, hay caba?as que utilizan el mismo RP para ambos sexos.
...
arch <- 'C:/Drive/Data/Merino/X/Manantiales/2022/machos2.csv'
wd <- 'C:/Drive/Data/Merino/X/Manantiales/2022/'
campo <- 'Mana'
manejo <- 'galpón'  #campo, caba?a, galp?n
ult.cam <- 2020
lote <- 'X'
sexo <- 'M'
cod.campo <- 239     #Teck:3 Cabo:277	CoyA:248	LVeg:280	Maiten:14	MLun:511	LagT:268	RioP:265	Mana:239 CerC:522
LOTE1 <- ''
d.esq1 <- 14
m.esq1 <- 3
output <- 'M2.csv'
