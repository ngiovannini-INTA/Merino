...
#aqui mergeo la base de datos con la genealogia para agregar sexo, año nac, edad madre, etc.
todo1 <- todo[,c(-5,-6)]
...
todo3$m <- todo3$MANEJO
  ...
  todo3$m[todo3$m=='cabaña'] <- 2
  todo3$m[todo3$m=='galpón'] <- 3
...
#cuento animales con pdf1 por grupo contemporáneo y elimino a los animales en grupos menores a por ej 5;
...
todo4 <-subset(todo4a, todo4a$Freq >=4) #ATENCION!!! Modificar a 5, excepcion en 2021
...
#Corre BLUP
#copiar el renum.par del año anterior
