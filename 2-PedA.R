...
dir.create('c:/Drive/Data/Merino/A/Pob/2023')
dir.create('c:/Drive/Data/Merino/A/Pob/2023/BLUP1')
dir.create('c:/Drive/Data/Merino/A/Pob/2023/BLUP2')
dir.create('c:/Drive/Data/Merino/A/Pob/2023/BLUP3')
dir.create('c:/Drive/Data/Merino/A/Pob/2023/BLUP4')

Provino <- ('c:/Drive/Data/Merino/A/Pob/2023')

BLUP1 <- ('c:/Drive/Data/Merino/A/Pob/2023/BLUP1')
BLUP2 <- ('c:/Drive/Data/Merino/A/Pob/2023/BLUP2')
BLUP3 <- ('c:/Drive/Data/Merino/A/Pob/2023/BLUP3')
BLUP4 <- ('c:/Drive/Data/Merino/A/Pob/2023/BLUP4')
...
pilca <- read.csv('c:/Drive/Data/Merino/A/Pilca/pilca new.csv',sep=';')
...
pilca$ident <- ifelse(is.na(pilca$carav)&!is.na(pilca$IDE),pilca$IDE,pilca$carav)
...
#aqu? genero otro archivo con las madres como RIM y su correspondiente AN
dos <- todo.ped
dos$rimmd <- dos$RIM
dos$anmad <- dos$AN
