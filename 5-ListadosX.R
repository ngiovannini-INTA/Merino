...
dir.create('c:/Drive/Data/Merino/X/Pob/2022/Resultados')
Result <- ('c:/Drive/Data/Merino/X/Pob/2022/Resultados')
...
#Listados de padres con filtros para para exportar a catálogo de padres AACM
...
plot(tendencia$AN,tendencia$ind02)
lines(tendencia$AN,tendencia$ind02)

write.table(tendencia, file = "TendenciaX_pob.csv", sep=";", row.names = F, col.names = T, quote=F, na=".", dec=dec)
...
t9 <- round(tapply(tend.est$ind10,tend.est$AN, mean, na.rm=T),digits = 0)
t10 <- round(tapply(tend.est$ind02,tend.est$AN, mean, na.rm=T),digits = 0)
...
rm(t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,tend.est,pad.est,padres2,padres3,padres4,prog2D.est,prog4D.est)
